...
import { getRecruitment } from '../../api/common'
  ...
  setup() {
    ...
    const state = reactive({
      ...
      columns: [
        ...
        { label: '操作人名称', prop: 'bossName', width: 100 },
        { label: '店铺名', prop: 'shopName', width: 150 },
        { label: '联系电话', prop: 'tel', width: 150 },
        { label: '微信', prop: 'wx', width: 150 },
        { label: '城市', prop: 'city', width: 100 },
        { label: '地址', prop: 'address', width: 100 },
